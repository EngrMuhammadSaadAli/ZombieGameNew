...
//	}
	...
	void Awake()
	{
		if (PlayerPrefs.GetInt ("myupdateweapon") == 1) {
			if (PlayerPrefs.GetInt ("weapons") == 4) {
				weaponOrder [4].GetComponent<WeaponBehavior> ().haveWeapon = true;
				firstWeapon = 4;
			}
		}

		if (PlayerPrefs.GetInt ("myupdateweapon") == 2) {
			if (PlayerPrefs.GetInt ("weapons") == 2) {
				weaponOrder [2].GetComponent<WeaponBehavior> ().haveWeapon = true;
				firstWeapon = 2;
			}
		}

		if (PlayerPrefs.GetInt ("myupdateweapon") == 3) {
			if (PlayerPrefs.GetInt ("weapons") == 3) {
				weaponOrder [3].GetComponent<WeaponBehavior> ().haveWeapon = true;
				firstWeapon = 3;
			}
		}
		if (PlayerPrefs.GetInt ("myupdateweapon") == 4) {
			if (PlayerPrefs.GetInt ("weapons") == 5) {
				weaponOrder [5].GetComponent<WeaponBehavior> ().haveWeapon = true;
				firstWeapon = 5;
			}
		}
		if (PlayerPrefs.GetInt ("weapons") == 7) {
			weaponOrder [7].GetComponent<WeaponBehavior> ().haveWeapon = true;
			firstWeapon = 7;
		}
		int a = PlayerPrefs.GetInt ("weapons");
		Debug.Log ("value: " + a);

		if (PlayerPrefs.GetInt ("changegun") == 1) {
			weaponOrder [4].GetComponent<WeaponBehavior> ().haveWeapon = true;
		}
		if (PlayerPrefs.GetInt ("changegun1") == 1) {
			weaponOrder [2].GetComponent<WeaponBehavior> ().haveWeapon = true;
		}
		if (PlayerPrefs.GetInt ("changegun2") == 1) {
			weaponOrder [3].GetComponent<WeaponBehavior> ().haveWeapon = true;
		}
		if (PlayerPrefs.GetInt ("changegun3") == 1) {
			weaponOrder [5].GetComponent<WeaponBehavior> ().haveWeapon = true;
		}
		if (PlayerPrefs.GetInt ("changegun") == 1) {
			weaponOrder [7].GetComponent<WeaponBehavior> ().haveWeapon = true;
	...
	void Start (){
		...
		if(weaponOrder[PlayerPrefs.GetInt("weapons")].GetComponent<WeaponBehavior>().haveWeapon){
			StartCoroutine(SelectWeapon(PlayerPrefs.GetInt("weapons")));
		...
		//Debug.Log ("Weapon"+PlayerPrefs.GetInt ("weapons"));
